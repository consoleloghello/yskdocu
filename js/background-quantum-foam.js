...
(function () {
  ...
  // ========== 可调参数 ==========
  const P2 = {
    targetCount: 55,         // 目标气泡数量（画面上的气泡数会维持在此值附近）
    maxBubbleRadius: 35,     // 气泡最大半径，单位像素（剧烈沸腾时气泡小而密）
    minBubbleRadius: 4,      // 气泡最小半径（新生成时的初始大小）
    growSpeed: 0.55,         // 气泡每帧的生长速度（剧烈沸腾，快速膨胀、快速破裂）
    spawnInterval: 3,        // 每隔 3 帧尝试生成一个新气泡（高密度成核）
    hueBase: 190,            // 基础色相：190 = 青色（cyan）
    hueRange: 120,           // 色相变化范围：从青色(190)到珊瑚色(310)
    popFlashFrames: 8        // 气泡破裂时粒子爆散的持续帧数
  };
